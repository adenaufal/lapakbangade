...
export const ExitIntentPopup: React.FC<ExitIntentPopupProps> = ({
  ...
  useEffect(() => {
    ...
    // Add listener after delay (avoid triggering immediately)
  ...
  }, [enabled, hasShown, isVisible, isAuthenticated]);
  ...
  const handleAccept = () => {
    trackEvent('exit_intent_accepted', { offer: 'fee_discount_50_percent' });
    window.location.href = '/#calculator?promo=FEE50';
    setIsVisible(false);
  };
    ...
    <AnimatePresence>
      {enabled && isVisible && (
        <>
          ...
          >
            <div className="pointer-events-auto w-full max-w-lg bg-white rounded-2xl shadow-2xl max-h-[calc(100dvh-2rem)] overflow-y-auto overflow-x-hidden">
              {/* Close Button */}
              <button
                onClick={handleClose}
              ...
              <div className="bg-gradient-to-r from-red-500 to-orange-500 p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <h2 className="text-3xl font-black mb-2">Tunggu Dulu!</h2>
                  <p className="text-lg opacity-90 font-medium">Ada penawaran fee spesial untuk Anda</p>
                </div>
              </div>
              ...
              <div className="p-8">
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-orange-200 rounded-xl p-6 mb-6 relative overflow-hidden">
                  ...
                  <div className="pt-4">
                    <div className="flex items-center justify-center gap-3 mb-4">
                      ...
                      <div className="text-5xl font-black text-orange-600">50%</div>
                      <span className="text-xl font-bold text-orange-800 self-end mb-2">OFF FEE</span>
                    </div>

                    <p className="text-center text-gray-800 font-semibold mb-2">
                      Diskon fee transaksi pertama Anda.
                    </p>
                    ...
                    <div className="bg-white rounded-lg p-4 border border-orange-200">
                      ...
                      <div className="space-y-1 text-sm">
                        <div className="flex justify-between">
                          <span className="text-gray-600">Fee normal</span>
                          <span className="font-semibold text-gray-700">$5.00</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Fee promo</span>
                          <span className="font-bold text-green-700">$2.50</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-center gap-2 mb-6 text-sm text-gray-600">
                  ...
                  <span>
                    Penawaran ini hanya tersedia <strong className="text-red-600">SEKARANG</strong>
                  </span>
                </div>
